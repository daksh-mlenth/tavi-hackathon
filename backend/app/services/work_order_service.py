...
class WorkOrderService:
    ...
    def create_work_order(
        self, work_order_data: WorkOrderCreate, parsed_data: Dict[str, Any]
    ) -> WorkOrder:
        trade_type = safe_enum(
            TradeType, parsed_data.get("trade_type"), TradeType(DEFAULT_TRADE_TYPE)
        )
        ...
        recurrence = safe_enum(
            Recurrence, parsed_data.get("recurrence"), Recurrence.NONE
        )
        ...
        work_order = WorkOrder(
            ...
            location_address=parsed_data.get("location_address")
            or parsed_data.get("location_city", "Address to be specified"),
