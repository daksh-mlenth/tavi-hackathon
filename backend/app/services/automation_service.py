...
from app.routes.webhooks import process_vendor_sms_response, process_vendor_email_response
...
class AutomationService:
    ...
    async def auto_handle_work_order(
        ...
        try:
            ...
            yield {
                "step": 3,
                "status": "in_progress",
                "message": f"📩 Collecting responses from vendors...",
                "timestamp": datetime.utcnow().isoformat()
            }
    ...
    async def _evaluate_and_select_best(self, work_order_id: UUID) -> Dict:
        ...
        return {
            ...
            "rating": round(best_quote.quality_score, 1) if best_quote.quality_score else 0,
            "composite_score": round(best_quote.composite_score, 2) if best_quote.composite_score else 0
        }
        ...
        return [
            {
                ...
                "composite_score": round(q.composite_score, 2) if q.composite_score else 0
            }
